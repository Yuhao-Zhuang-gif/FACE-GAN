...
class FaceAging(object):
    def __init__(self,
        ...
        self.EG_loss_summary = tf.compat.v1.compat.v1.summary.scalar('EG_loss', self.EG_loss)
    ...
    def train(self,
        ...
        self.EG_global_step = tf.compat.v1.Variable(0, trainable=False, name='global_step')
...
#        self.z_summary = tf.cast(self.z_summary,dtype=tensor)
...
#                current = tf.keras.layers.batch_norm(
#                    current,
#                    scale=False,
